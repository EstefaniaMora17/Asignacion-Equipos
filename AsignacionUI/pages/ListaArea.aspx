    ...
    <div class="row">
        <div class="col">
          ...
          <%--  <div class="table-responsive">
                ...
                <asp:GridView GridLinesVisibility="None" ID="GridDataArea" CssClass="table table-condensed table-hover" AutoGenerateColumns="false" runat="server" RowStyle-ForeColor="#000">
                    <Columns>
