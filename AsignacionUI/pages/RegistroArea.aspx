                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="txtArea" runat="server" ErrorMessage="* Campo Obligatorio" ValidationGroup="GuardarCampo"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="DllArea" runat="server" ErrorMessage="* Campo Obligatorio" InitialValue="0" ValidationGroup="ActualizarArea"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-username">Area</label>
                                                <asp:TextBox ID="txtAreaUpdate" CssClass="form-control" runat="server"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="txtAreaUpdate" runat="server" ErrorMessage="* Campo Obligatorio" ValidationGroup="ActualizarArea"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col  d-flex justify-content-center ">
                                            <asp:Button ID="Button2" CssClass="btn btn-outline-danger btnmargin" OnClick="btnEditar_Click" runat="server" Text="Editar" ValidationGroup="ActualizarArea" />
                                        </div>
                                    </div>
                                </div>
                            </div>
