                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtIccid" CssClass="form-control" MaxLength="17" runat="server"></asp:TextBox>
                                      <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ControlToValidate="txtIccid" runat="server" ErrorMessage="* Campo Obligatorio"></asp:RequiredFieldValidator>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtMin" runat="server" ErrorMessage="* Campo Obligatorio"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                              ...
                              <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="txtPlandatos" runat="server" ErrorMessage="* Campo Obligatorio"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="DllidEstadoSim" runat="server" ErrorMessage="* Campo Obligatorio"  InitialValue=0 ></asp:RequiredFieldValidator>
