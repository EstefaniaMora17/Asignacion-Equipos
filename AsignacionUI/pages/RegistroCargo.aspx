                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="txtCargo" runat="server" ErrorMessage="* Campo Obligatorio" ValidationGroup="GuardarCampo"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="tab-pane fade" id="tabs-icons-text-2" role="tabpanel" aria-labelledby="tabs-icons-text-2-tab">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-username">Cargo</label>
                                                <asp:DropDownList ID="DllCargo" CssClass="form-control" runat="server">
                                                </asp:DropDownList>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="DllCargo" runat="server" ErrorMessage="* Campo Obligatorio" InitialValue="0" ValidationGroup="ActualizarCargo"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-username">Cargo</label>
                                                <asp:TextBox ID="txtCargoUpdate" CssClass="form-control" runat="server"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="txtCargoUpdate" runat="server" ErrorMessage="* Campo Obligatorio" ValidationGroup="ActualizarCargo"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col  d-flex justify-content-center ">
                                            <asp:Button ID="Button2" CssClass="btn btn-outline-danger btnmargin" OnClick="btnEditar_Click" runat="server" Text="Editar" ValidationGroup="ActualizarCargo" />
                                        </div>
                                    </div>
